  ...
  return (
    <section id="about" className="flex justify-center items-center">
      ...
      <div className="max-w-xl">
        <FadeUp>
          <h1 className="text-zinc-100 underline underline-offset-4 decoration-[#55c5e9] text-2xl font-semibold mb-10">
            Sobre Mim
          </h1>
        </FadeUp>
        <FadeRight>
        ...
        <FadeRight>
          ...
          <FadeRight>
          <p className="font-light text-lg text-zinc-300">
            Eu sou apaixonado por desenvolvimento web e estou sempre antenado
            nas últimas tendências e novidades da indústria.
          </p>
          </FadeRight>
          <FadeRight>
          <p className="font-light text-lg text-zinc-300">
            ...
            melhorar o desempenho e a usabilidade dos sites que eu desenvolvo.
          </p>
          </FadeRight>
        </div>
        </FadeRight>
